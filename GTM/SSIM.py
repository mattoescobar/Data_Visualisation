...
@author: Antoine Vacavant, ISIT lab, antoine.vacavant@iut.u-clermont1.fr,
...
def compute_ssim(img_mat_1, img_mat_2):
    ...
    img_mat_sigma_1_sq = scipy.ndimage.filters.convolve(img_mat_1_sq,
                                                        gaussian_kernel)
    img_mat_sigma_2_sq = scipy.ndimage.filters.convolve(img_mat_2_sq,
                                                        gaussian_kernel)
